...
class Index extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("pages/Index.ets(49:5)");
            if (!isInitialRender) {
                Column.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Stack.debugLine("pages/Index.ets(50:7)");
            Stack.height('100%');
            Stack.width('100%');
            Stack.backgroundImage({ "id": 16777235, "type": 20000, params: [], "bundleName": "com.example.canvascom", "moduleName": "entry" }, ImageRepeat.NoRepeat);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Canvas.debugLine("pages/Index.ets(51:9)");
            Canvas.width('100%');
            Canvas.height('100%');
            Canvas.onReady(() => {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Image.create({ "id": 16777240, "type": 20000, params: [], "bundleName": "com.example.canvascom", "moduleName": "entry" });
            Image.debugLine("pages/Index.ets(67:9)");
            Image.width('19.3%');
            Image.height('10.6%');
