...
class Index extends ViewPU {
    ...
    listGroupItemHeaderBuilder(item, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.backgroundColor({ "id": 16777221, "type": 10001, params: [], "bundleName": "com.example.secondlevelscrollbox", "moduleName": "entry" });
            if (!isInitialRender) {
                Row.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.fontSize(16);
            Text.fontColor({ "id": 16777222, "type": 10001, params: [], "bundleName": "com.example.secondlevelscrollbox", "moduleName": "entry" });
    ...
    secondLevelItemBuilder(item, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.width('100%');
            Row.height(90);
            Row.backgroundColor({ "id": 16777226, "type": 10001, params: [], "bundleName": "com.example.secondlevelscrollbox", "moduleName": "entry" });
            Row.borderRadius(10);
            Row.clip(true);
            if (!isInitialRender) {
                Row.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.fontSize(14);
            Text.fontColor({ "id": 16777225, "type": 10001, params: [], "bundleName": "com.example.secondlevelscrollbox", "moduleName": "entry" });
            Text.fontWeight(FontWeight.Bold);
            if (!isInitialRender) {
                Text.pop();
            }
            ...
            if (this.isLoad) {
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        List.height('100%');
                        List.layoutWeight(1);
                        List.backgroundColor({ "id": 16777223, "type": 10001, params: [], "bundleName": "com.example.secondlevelscrollbox", "moduleName": "entry" });
                        if (!isInitialRender) {
                            List.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        List.height('100%');
                        List.layoutWeight(3);
                        List.backgroundColor({ "id": 16777221, "type": 10001, params: [], "bundleName": "com.example.secondlevelscrollbox", "moduleName": "entry" });
...
class FirstLevelItemBuilder extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.width('100%');
            Row.height(60);
            Row.backgroundColor(this.isSelect ? { "id": 16777221, "type": 10001, params: [], "bundleName": "com.example.secondlevelscrollbox", "moduleName": "entry" } : '');
            Row.alignItems(VerticalAlign.Center);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.fontColor(this.isSelect ? { "id": 16777222, "type": 10001, params: [], "bundleName": "com.example.secondlevelscrollbox", "moduleName": "entry" } : { "id": 16777224, "type": 10001, params: [], "bundleName": "com.example.secondlevelscrollbox", "moduleName": "entry" });
            if (!isInitialRender) {
                Text.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
