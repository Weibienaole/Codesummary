...
class Index extends ViewPU {
    ...
    initialRender() {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Image.create({ "id": 16777228, "type": 20000, params: [], "bundleName": "com.example.formlistv2", "moduleName": "entry" });
            Image.width(50);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            if (['select', 'radio', 'datePicker'].includes(this.formItem.type)) {
                this.ifElseBranchUpdateFunction(0, () => {
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Image.create({ "id": 16777222, "type": 20000, params: [], "bundleName": "com.example.formlistv2", "moduleName": "entry" });
                        Image.width(20);
                        if (!isInitialRender) {
                            Image.pop();
                        }
