...
const int32_t MEDIA_ARROW = 0x01000006;
const int32_t MEDIA_CALENDAR = 0x01000007;
const int32_t MEDIA_EDIT = 0x01000008;
const int32_t MEDIA_HEART = 0x01000009;
const int32_t MEDIA_ICON = 0x0100000a;
const int32_t MEDIA_SEX = 0x0100000b;
const int32_t MEDIA_USER = 0x0100000c;
const int32_t MEDIA_USER2 = 0x0100000d;
