class TargetList extends ViewPU {
    ...
    ListItemBuilder(targetItem, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.create();
            Row.debugLine("pages/TargetsList.ets(14:5)");
            Row.width('100%');
            Row.height(60);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/TargetsList.ets(15:7)");
            Text.fontSize(15);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/TargetsList.ets(16:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/TargetsList.ets(17:9)");
            Text.fontSize(14);
            Text.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/TargetsList.ets(18:9)");
            Text.fontSize(12);
            Text.fontColor('gray');
            if (!isInitialRender) {
                Text.pop();
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/TargetsList.ets(25:5)");
            Column.height('100%');
            Column.width('100%');
            if (!isInitialRender) {
                Column.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/TargetsList.ets(26:7)");
            Row.width('100%');
            Row.alignItems(VerticalAlign.Center);
            Row.justifyContent(FlexAlign.SpaceBetween);
            if (!isInitialRender) {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('子目标');
            Text.debugLine("pages/TargetsList.ets(27:9)");
            Text.fontSize(20);
            Text.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('编辑');
            Text.debugLine("pages/TargetsList.ets(28:11)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            List.debugLine("pages/TargetsList.ets(30:7)");
            List.width('100%');
            List.margin({ top: 10 });
            if (!isInitialRender) {
                List.pop();
            ...
            const forEachItemGenFunction = _item => {
                const targetItem = _item;
                {
                    ...
                    const itemCreation = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("pages/TargetsList.ets(32:11)");
                        if (!isInitialRender) {
                            ListItem.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Blank.create();
            Blank.debugLine("pages/TargetsList.ets(37:7)");
            if (!isInitialRender) {
                Blank.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
            ...
            if (this.isEdit) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("pages/TargetsList.ets(39:9)");
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("pages/TargetsList.ets(42:9)");
                        Button.backgroundColor('#e6e7ea');
